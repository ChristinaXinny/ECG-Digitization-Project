"""Start training script for ECG digitization - no Unicode characters."""
...
def train_stage0():
    ...
    try:
        ...
        print_with_time("Please install required packages: pip install torch torchvision timm numpy pandas opencv-python loguru")
        return False
...
def main():
    """Main function."""
    print("ECG Digitization Training")
    print("=" * 50)
