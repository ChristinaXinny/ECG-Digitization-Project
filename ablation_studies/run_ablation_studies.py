...
def print_banner():
    ...
    banner = """
╔══════════════════════════════════════════════════════════════╗
║                ECG DIGITIZATION - ABLATION STUDIES               ║
║                                                              ║
║  Comprehensive evaluation of model components and design choices ║
║              to prove the necessity of each module.             ║
╚══════════════════════════════════════════════════════════════╝
    """
    print(banner)
